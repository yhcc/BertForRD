...
from mix.data.loader import BiUnAlignLoader
...
model = JointBertReverseDict(pre_name, train_word2bpes=train_word2bpes, target_word2bpes=target_word2bpes,
                             pad_id=pad_id, num_languages=2)
...
callbacks = [GradientClipCallback(clip_type='value', clip_value=5),
